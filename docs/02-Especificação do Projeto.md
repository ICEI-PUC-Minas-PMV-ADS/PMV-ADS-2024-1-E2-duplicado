...
|--------------------|------------------------------------|----------------------------------------|
| Pais e Alunos      | Ter um cadastro para que possa ser recebido doações, seja em dinheiro ou até mesmo na necessidade especifica do aluno, como cesta básica, material escolar, roupa escolar e tudo que for pertinente para que seja mantido o frequência do aluno na escola, seria de muita utilidade conseguir mostrar a rotina e o desenvolvimento do aluno na escola para que os empreendedores socias acompanhe mais de perto cada criança que receber as doações.  | Com a clareza de informações disponível na aplicação fica mais fácil aos empreendedores saber a real necessidade daquele aluno em situação de carência social, podendo assim contribuir com mais foco na real necessidade do aluno. |
